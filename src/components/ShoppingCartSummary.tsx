...
export default function ShoppingCartSummary(props:Props) {
    ...
    const totalQuantityRebatePriceAccumulated = items.reduce((accumulator, item) => {
    ...
    const totalWith10PercentDiscount = totalQuantityRebatePriceAccumulated >= 300 ? totalQuantityRebatePriceAccumulated * 0.9 : totalQuantityRebatePriceAccumulated;
    ...
    return (
      ...
      <>
          ...
          <h3>Pris med rabat: {totalQuantityRebatePriceAccumulated.toLocaleString('da-DK', { style: 'currency', currency: 'DKK', minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
          <h3>10% rabat på ordrer over 300 kr.: {totalWith10PercentDiscount.toLocaleString('da-DK', { style: 'currency', currency: 'DKK', minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
</>
